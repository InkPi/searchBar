Deployed project for view: http://search-app.surge.sh/

Project created using React.

Search Bar using a movies API
...
he compiled code will be added to it automatically during the build process.
